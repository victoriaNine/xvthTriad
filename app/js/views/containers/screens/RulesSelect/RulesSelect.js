import $ from 'jquery';
import { template, each, min, max, sampleSize } from 'lodash';
...
function setAvailableRules (opponent) {
    ...
    var albumSizeMin = opponent ? min([albumSize, opponent.albumSize]) : albumSize;
    var albumSizeMax = opponent ? max([albumSize, opponent.albumSize]) : albumSize;
