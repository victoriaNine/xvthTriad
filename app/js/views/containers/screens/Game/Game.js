...
function transitionIn () {
    ...
    var userCards     = map(this.userCardViews, "$el");
    var opponentCards = map(this.opponentCardViews, "$el");
...
function getOpponentSelectedCards (event, response) {
    ...
    var previousSelection = map(this.lostCards, "deckIndex");
    var deselection       = difference(previousSelection, opponentSelection);
    var deselectedCards   = [];
